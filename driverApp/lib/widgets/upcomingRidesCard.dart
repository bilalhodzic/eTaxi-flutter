...
class UpcomingRideCard extends StatelessWidget {
  ...
  UpcomingRideCard({Key? key, required this.data}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(right: b * 15, bottom: h * 16, left: b * 15),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Spacer(),
              Padding(
                padding: EdgeInsets.only(top: h * 10, right: b * 10),
                child: PopupMenuButton<String>(
                  padding: EdgeInsets.only(left: b * 0, right: b * 0),
